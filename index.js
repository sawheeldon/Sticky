...
var Board = React.createClass({
    ...
    render: function() {
        return (<div className="board">
                    ...
                    <h1>Sticky</h1>
                    <p id="#welcomeText">Welcome to Sticky your note sticking app. Click the Add button below to add sticky notes. Edit or delete as many notes as you like. You can even drag the notes around. </p>
